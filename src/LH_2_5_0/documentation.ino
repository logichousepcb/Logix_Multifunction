...
// 9/10/2023  - Added bollean trigger to configuration file to allow to shut off access point
// 9/16/2023  - Added bollean trigger to configuration file to allow to shut off on board buttons
// VERSION 2.5.0
// 12/26/2023 - Added link to github for latest release on update page
/* TO DO LIST
