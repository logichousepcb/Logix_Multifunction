...
This page allows you to change the pin names to a more friendly name that will be passed to Home Assistant.  It also allows you to select from 7 different device classes.<br>
